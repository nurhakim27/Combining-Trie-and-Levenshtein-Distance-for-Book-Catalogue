...
// Ganti 'trieLD-v1.php' jika nama file Anda berbeda.
// ==========================================================
require_once 'trieLD-v1.php';
...
$file_output_csv = 'hasil_benchmark_trie_levenshtein.csv';

// Ambil Trie yang sudah di-cache agar tidak membangun ulang
$cacheFile = 'trie_cache.dat';
if (!file_exists($cacheFile)) {
    die("File cache '{$cacheFile}' tidak ditemukan. Jalankan dulu skrip trieLD-v1.php sekali dari browser untuk membuatnya.");
}
...
foreach ($daftar_judul_tes as $judul) {
    ...
    for ($i = 0; $i < $jumlah_pengujian_per_judul; $i++) {
        ...
        // --- INTI LOGIKA PENCARIAN (disalin dari trieLD-v1.php) ---
