...
// Ganti 'rocchio-relevance-ubpress.php' jika nama file Anda berbeda.
// ==========================================================
$algorithm_file = 'rocchio-relevance-ubpress.php';
...
$file_output_csv = 'hasil_benchmark_rocchio_ubpress.csv';
...
foreach ($daftar_judul_tes as $judul) {
    ...
    for ($i = 0; $i < $jumlah_pengujian_per_judul; $i++) {
        ...
        // --- INTI LOGIKA PENCARIAN (disalin dari rocchio-relevance-ubpress.php) ---
