...
// Ganti 'damareu-trie-ubpress.php' jika nama file Anda berbeda.
// ==========================================================
$algorithm_file = 'damerau-trie-ubpress.php';
...
$file_output_csv = 'hasil_benchmark_damerau_trie_ubpress.csv';

// Ambil Trie yang sudah di-cache agar tidak membangun ulang
$cacheFile = 'trie_cache_damerau_ubpress_fixed.dat';
...
echo "Memulai benchmark (Metode Trie + Damerau-Levenshtein)... \n";
$judul_ke = 0;
foreach ($daftar_judul_tes as $judul) {
    ...
    for ($i = 0; $i < $jumlah_pengujian_per_judul; $i++) {
        ...
        // --- INTI LOGIKA PENCARIAN (disalin dari damareu-trie-ubpress.php) ---
        $suggestions = [];
