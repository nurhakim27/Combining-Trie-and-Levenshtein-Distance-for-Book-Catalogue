...
// Ganti 'sequential-search.php' jika nama file Anda berbeda.
// ==========================================================
require_once 'sequential-search.php';
...
$file_output_csv = 'hasil_benchmark_sequential_search.csv';
...
foreach ($titles_for_testing as $judul) {
    ...
    for ($i = 0; $i < $jumlah_pengujian_per_judul; $i++) {
        ...
        // --- INTI LOGIKA SEQUENTIAL SEARCH (disalin dari sequential-search.php) ---
        $suggestions = [];
        if (!empty($query)) {
