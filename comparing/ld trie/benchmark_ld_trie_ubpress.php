...
// Ganti 'LD-Trie-ubpress.php' jika nama file Anda berbeda.
// ==========================================================
$algorithm_file = 'LD-Trie-ubpress.php';
...
$file_output_csv = 'hasil_benchmark_ld_trie_ubpress.csv';
...
echo "Memulai benchmark (Metode Levenshtein Dulu)... Ini akan memakan waktu.\n";
$judul_ke = 0;
foreach ($titles as $judul) {
    ...
    for ($i = 0; $i < $jumlah_pengujian_per_judul; $i++) {
        ...
        // --- INTI LOGIKA PENCARIAN (disalin dari LD-Trie-ubpress.php) ---
        $suggestions = [];
