...
// Ganti 'trie-only-ubpress.php' jika nama file Anda berbeda.
// ==========================================================
$algorithm_file = 'trie-only-ubpress.php';
...
$file_output_csv = 'hasil_benchmark_trie_only_ubpress.csv';

// Ambil Trie yang sudah di-cache agar tidak membangun ulang
$cacheFile = 'trie_cache_pure_ubpress.dat';
...
echo "Memulai benchmark (Metode Trie Murni)... \n";
$judul_ke = 0;
foreach ($daftar_judul_tes as $judul) {
    ...
    for ($i = 0; $i < $jumlah_pengujian_per_judul; $i++) {
        ...
        // --- INTI LOGIKA PENCARIAN (disalin dari trie-only-ubpress.php) ---
        $suggestions = [];
